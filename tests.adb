...
procedure Tests is
   ...
   function Func_Null is new Unchecked_Conversion (System.Address, Integrand_Ptr);
...
begin
   ...
   Integrate (Func_One'Access, Bounds_1D, 5, 1000, Res, Var);
   ...
   Integrate (Func_Linear'Access, Bounds_1D, 5, 1000, Res, Var);
   ...
   Integrate (Func_One'Access, Bounds_2D, 5, 2000, Res, Var);
   ...
   Integrate (Func_3D'Access, Bounds_3D, 5, 2000, Res, Var);
   ...
   begin
      Integrate (Func_One'Access, Bounds_Bad, 1, 10, Res, Var);
      Assert (False, "Expected Invalid_Input_Error");
   exception
      when Invalid_Input_Error => Put_Line ("      PASS");
   end;
   ...
   begin
      Integrate (Func_One'Access, Bounds_Empty, 1, 10, Res, Var);
      Assert (False, "Expected Invalid_Input_Error");
   exception
      when Invalid_Input_Error => Put_Line ("      PASS");
   end;
   ...
   begin
      ...
      declare Iter : Integer := 0; begin
         Integrate (Func_One'Access, Bounds_1D, Iter, 100, Res, Var);
   ...
   begin
      declare Evals : Integer := 0; begin
         Integrate (Func_One'Access, Bounds_1D, 5, Evals, Res, Var);
         Assert (False, "Expected Constraint_Error");
      end;
   exception
      when Constraint_Error => Put_Line ("      PASS");
   ...
   Integrate (Func_Negative'Access, Bounds_1D, 3, 1000, Res, Var);
   ...
   Integrate (Func_Linear'Access, Bounds_1D, 5, 500, Res, Var, Adaptive => False);
   ...
   Integrate (Func_Linear'Access, Bounds_1D, 5, 500, Res, Var, Adaptive => True, Smooth_Grid => False);
   ...
   begin
      Integrate (Func_One'Access, Narrow, 3, 1000, Res, Var);
